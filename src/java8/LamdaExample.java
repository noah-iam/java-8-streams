...
//         getGroupByAndCountOnTempArray();
    ...
    private static void useOfFlatMapSet() {
        Set<String> result = allEmployees.stream()
                .map(Employee::getActivities)
                .flatMap(List::stream)
                .collect(toSet());
        System.out.println(result);
...
//        result.forEach(System.out::println);
    ...
    private static void getFilterByName() {
        List<Employee> result = allEmployees
                .stream()
                .filter(employee -> employee.getName().equalsIgnoreCase("amol"))
                .collect(Collectors.toList());
        result.forEach(System.out::println);
        // System.out.println(result);
    }
    ...
    private static void getReduceFunctionOnSalary() {
        Optional<Integer> result = allEmployees
                .stream()
    ...
    private static void getMaxSalariedEmployee() {
        ...
        Optional<Employee> result = allEmployees
                .stream()
                .reduce(
                        (e1,e2) -> { return e1.getSalary() > e2.getSalary() ? e1 : e2;
                } );
        System.out.println(result.get());
    }
    ...
    private static void getJoinedEmployeeByNameWithDeliMeterAndWithSuffix_Prefix() {
...
//        System.out.println(result);
        ...
        Set<String> result = allEmployees
                .stream()
    ...
    private static void getMinBy_Employee() {
        Optional<Employee> result = allEmployees
                .stream()
                .collect(minBy(Comparator.comparing(Employee::getSalary)));
        System.out.println(result.get());
    }

    private static void getMaxBy_Employee() {
        Optional<Employee> result = allEmployees
                .stream()
    ...
    private static void getSumOfSalaryOfEmployees() {
        Long result = allEmployees
                .stream()
                .collect(summingLong(Employee::getSalary));
        System.out.println(result);
    }

    private static void getGroupByAddressEmployees() {
        Map<String,List<Employee>> result = allEmployees
                .stream()
                .collect(groupingBy(Employee::getAddress));
        System.out.println(result);
    }
    ...
    private static void getCustomGroupByMore() {
        Map<String,Double> result = allEmployees
                .stream()
                .collect(groupingBy(employee -> employee.getAddress(),
                        averagingDouble(employee -> employee.getSalary())));

        System.out.println(result);
    }

    private static void getGroupByAndMax() {
        Map<String, Optional<Employee>> result = allEmployees
                .stream()
                .collect(groupingBy(employee -> employee.getAddress(),
        ...
        System.out.println(result);
        /*
        {Etawah=Optional[Employee{name='ranu', age=31, address='Etawah', activities=[badminton, ludo], salary=110000}],
         Kanpur=Optional[Employee{name='reshu', age=28, address='Kanpur', activities=[badminton, chess, gaming], salary=100000}],
         Gurgaon=Optional[Employee{name='pratik', age=30, address='Gurgaon', activities=[cricket, badminton, chess], salary=120000}],
          Noida=Optional[Employee{name='atul', age=28, address='Noida', activities=[cricket, badminton, chess], salary=50000}],
           Bharthana=Optional[Employee{name='amol', age=31, address='Bharthana', activities=[cricket, badminton, football], salary=99999}]}
         */
    }

    private static void getGroupByAndCount() {
        Map<String, Long> result = allEmployees
                .stream()
                .collect(groupingBy(employee -> employee.getAddress(),
                        counting()));
        ...
        /*
        Output:
        {Etawah=1, Kanpur=1, Gurgaon=4, Noida=1, Bharthana=1}
         */
    }

    private static void getGroupByAndCountOnTempArray() {
        Map<String, Long> result = asList(new String[]{"pratik","amol","pratik","amol","reshu","pratik","amol","reshu"})
                .stream()
    ...
    public static List<Employee> getEmployees(){
        allEmployees.add(new Employee("pratik",30,"Gurgaon",asList(new String[]{"cricket","badminton","chess"}),120000));
        allEmployees.add(new Employee("reshu",28,"Kanpur",asList(new String[]{"badminton","chess","gaming"}),100000));
        allEmployees.add(new Employee("amol",31,"Bharthana",asList(new String[]{"cricket","badminton","football"}),99999));
        allEmployees.add(new Employee("ranu",31,"Etawah",asList(new String[]{"badminton","ludo"}),110000));
        allEmployees.add(new Employee("atul",28,"Noida",asList(new String[]{"cricket","badminton","chess"}),50000));
        allEmployees.add(new Employee("chanchal",30,"Gurgaon",asList(new String[]{"cricket","badminton",}),90000));
        allEmployees.add(new Employee("shivangi",30,"Gurgaon",asList(new String[]{"cricket","chess"}),56000));
        allEmployees.add(new Employee("shivani",31,"Gurgaon",asList(new String[]{"badminton","chess"}),44000));
//        allEmployees.add(new Employee("pratik",30,"Gurgaon",120000));
//        allEmployees.add(new Employee("pratik",30,"Gurgaon",120000));
//        allEmployees.add(new Employee("pratik",30,"Gurgaon",120000));
//        allEmployees.add(new Employee("pratik",30,"Gurgaon",120000));
//        allEmployees.add(new Employee("pratik",30,"Gurgaon",120000));
